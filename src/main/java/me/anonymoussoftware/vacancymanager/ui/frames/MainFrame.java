...
public class MainFrame extends JFrame implements VacancySearchListener {
    ...
    public MainFrame() {
		...
		JSplitPane splitPane = new JSplitPane(JSplitPane.HORIZONTAL_SPLIT, this.vacancyListPanel, new VacancyDescriptionPanel());
	...
	private void showUnableToLoadVacanciesFromFileMessageDialog() {
		JOptionPane.showMessageDialog(this, "Unable to load vacancies from file", "Error",
				JOptionPane.ERROR_MESSAGE);
	}
	
	private void showSuccessfullyLoadedVacanciesMessageDialog() {
		JOptionPane.showMessageDialog(this, "Vacancies are saved successfully",
				"Success", JOptionPane.INFORMATION_MESSAGE);
	}
	
	private void showUnableToSaveVacanciesToFile() {
		JOptionPane.showMessageDialog(this, "Unable to save vacancies to file", "Error",
				JOptionPane.ERROR_MESSAGE);
	}
